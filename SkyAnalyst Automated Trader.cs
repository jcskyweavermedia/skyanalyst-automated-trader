...
namespace cAlgo.Robots
{
    ...
    public class NewsTradePanelWWebhook : Robot
    {
        ...
        [Parameter("Max Negative Trades/Day", Group = "Daily Limits", DefaultValue = 1)]
        ...
        protected override void OnStart()
        {
            ...
            if (SymbolFilter == SymbolFilterOption.Choose_Your_Instrument && BotMode == BotModeType.Auto)
            {
                ...
                {
                    Text = "SkyAnalyst Automated Trader Pro 2.0",
        ...
        public void ExecuteWebhookTrade(WebhookPayload webhook)
        {
            try
            {
                ...
                string label1 = $"{_labelPrefix}{shortTradeId}_TP1";
                string label2 = $"{_labelPrefix}{shortTradeId}_TP2";
                string label3 = $"{_labelPrefix}{shortTradeId}_TP3";
...
#pragma warning restore 0618
        ...
        private void BroadcastTPModification(Position pos)
        {
            ...
            // Strip bot-specific prefix before broadcasting so receivers get standardized labels
...
#pragma warning restore 0618
        ...
        private void DetectNewPositions()
        {
            ...
            foreach (var pos in newly)
            {
                ...
                // Extract trade group ID from label (strip prefix first)
                string labelWithoutPrefix = pos.Label.Substring(_labelPrefix.Length);
                string tradeGroupId = _labelPrefix.TrimEnd('_');
